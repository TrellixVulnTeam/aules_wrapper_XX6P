...
var Session = /** @class */ (function () {
    function Session(options) {
        ...
        if (options.useCookieJar) {
            this.request = (0, axios_cookiejar_support_1.wrapper)(axios_1.default.create({ jar: this.cookieJar }));
            if (options.cookies)
                try {
                    var cookies = JSON.parse(options.cookies);
                    cookies.forEach(function (c) { return _this.cookieJar.setCookieSync("".concat(c.key, "=").concat(c.value), _this.baseURL + c.path, { secure: true }); });
                }
                catch (_a) { }
        }
    }
    Session.prototype.apiRequest = function (method, url, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        var req = this.request(__assign({ method: method, url: this.baseURL + url }, options));
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.apiRequest('GET', "/".concat(this.options.course, "/login/index.php"))];
                    case 1:
                        ...
                        return [4 /*yield*/, this.apiRequest('POST', "/".concat(this.options.course, "/login/index.php"), {
                                headers: {
                    ...
                    case 2:
                        ...
                        if (usermenu) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    error: (_d = loginResponseDoc.querySelector('.alert.alert-danger')) === null || _d === void 0 ? void 0 : _d.text
                                }];
                        }
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.apiRequest('GET', "/".concat(this.options.course, "/my"))];
                    case 1:
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.apiRequest('GET', "/".concat(this.options.course, "/user/profile.php"))];
                    case 1:
    ...
    Session.prototype.getEvents = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.apiRequest('POST', "/".concat(this.options.course, "/lib/ajax/service.php?sesskey=").concat(this.sesskey, "&info=core_calendar_get_calendar_upcoming_view"), {
    ...
    Session.prototype.getClasses = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.apiRequest('POST', "/".concat(this.options.course, "/lib/ajax/service.php?sesskey=").concat(this.sesskey, "&info=core_course_get_enrolled_courses_by_timeline_classification"), {
